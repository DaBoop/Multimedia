...
// stage content:
(lib.Lab41HTMLCanvas_Canvas = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		this.stop();
		function  f1 () { this.stop(); }
		function  f2 () { this.play(); }
		function  f3 () { this.gotoAndStop(1); }
		this.stopButton.addEventListener("click", f1.bind(this) );
		this.startButton.addEventListener("click", f2.bind(this) );
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"sounds/Записьonlineaudioconvertercom.mp3?1614082652573", id:"Записьonlineaudioconvertercom"}
	],
	preloads: []
};
